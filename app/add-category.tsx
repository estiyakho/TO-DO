...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: 14, borderWidth: 1, fontFamily: AppFonts.medium, fontSize: 16, minHeight: 56, paddingHorizontal: 14, paddingVertical: 12 },
  textArea: { minHeight: 88 },
  footer: { flexDirection: 'row', gap: 12, marginTop: 'auto', paddingTop: 20 },
  secondaryButton: { alignItems: 'center', borderRadius: 14, borderWidth: 1, flex: 1, justifyContent: 'center', paddingVertical: 14 },
  secondaryButtonText: { fontFamily: AppFonts.semibold, fontSize: 15 },
  primaryButton: { alignItems: 'center', borderRadius: 14, flex: 1, justifyContent: 'center', paddingVertical: 14 },
